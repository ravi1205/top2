class OrderCardsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @order_card.save
        format.html { redirect_to @order_card, notice: 'Order card was successfully created.' }
  ...
  private
    ...
    def order_card_params
      params.require(:order_card).permit(:user_email, :items, :quantity, :unit_price, :total)
    end
end
